...
const Home: React.FC = () => {
    ...
    const loadCharacters = async () => {
        ...
        const res = await fetch("https://gateway.marvel.com/v1/public/characters?ts=jonas&apikey=81272e1a0b9f8a98fa9dd90f785074a9&hash=907952132a795d15f7da63aa81a561f1&limit=" + limit + "&offset=" + offset);
        ...
        const charactersData: CharacterProps[] = dados.data.results.map((character: any) => ({
            ...
            total: character.comics.available + character.series.available + character.stories.available + character.events.available
        }));
